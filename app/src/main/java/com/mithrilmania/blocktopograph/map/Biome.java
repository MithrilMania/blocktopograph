...
public enum Biome {
    ...
    SMALL_END_ISLANDS(40, "Small End Island", Color.fromRGB(250, 223, 85)),
    END_MIDLANDS(41, "End Midlands", Color.fromRGB(250, 223, 85)),
    END_HIGHLANDS(42, "End Highlands", Color.fromRGB(250, 223, 85)),
    END_BARRENS(43, "End Barrens", Color.fromRGB(250, 223, 85)),
    WARM_OCEAN(44, "Warm Ocean", Color.fromRGB(81, 79, 195)),
    LUKEWARM_OCEAN(45, "Lukewarm Ocean", Color.fromRGB(81, 79, 195)),
    COLD_OCEAN(46, "Cold Ocean", Color.fromRGB(81, 79, 195)),
    DEEP_WARM_OCEAN(47, "Deep Warm Ocean", Color.fromRGB(81, 79, 195)),
    DEEP_LUKEWARM_OCEAN(48, "Deep Lukewarm Ocean", Color.fromRGB(81, 79, 195)),
    DEEP_COLD_OCEAN(49, "Deep Cold Ocean", Color.fromRGB(81, 79, 195)),
    DEEP_FROZEN_OCEAN(50, "Deep Frozen Ocean", Color.fromRGB(81, 79, 195)),
